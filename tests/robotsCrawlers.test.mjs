...
// eligibility. Tokens verified vs Anthropic support.claude.com article 8896518;
// shipped first on oia-web#77.

const robots = readFileSync(
  path.resolve(import.meta.dirname, '..', 'public/robots.txt'),
  'utf8',
);
const uaLine = (name) => new RegExp(`^User-agent:\\s*${name}\\s*$`, 'm');
